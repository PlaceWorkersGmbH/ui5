		...
		XMLTemplateProcessor.parseTemplate = function(xmlNode, oView) {
			...
			function createExtension(node, oView) {
				...
				if (sap.ui.core.CustomizingConfiguration) {
					...
					var extensionConfig = sap.ui.core.CustomizingConfiguration.getViewExtension(sCurrentName, node.getAttribute("name"), oView);
					if (extensionConfig) {
			...
			function createRegularControls(node) {
				...
				if (sap.ui.core.CustomizingConfiguration && sOriginalControlId) {
					var mCustomSettings = sap.ui.core.CustomizingConfiguration.getCustomProperties(sCurrentName, sOriginalControlId, oView);
					if (mCustomSettings) {
